...
map_tiles = "cartodbdark_matter" if theme_choice == "Dark Mode" else "OpenStreetMap"
...
# Changed label and default value to INR (₹)
cost_per_km = st.sidebar.number_input("Cost per Order-km (₹)", value=15.0, step=1.0)
