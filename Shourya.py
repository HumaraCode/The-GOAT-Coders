...
# ==============================================================================
# 1. USER AUTHENTICATION & DATABASE INITIALIZATION
# ==============================================================================

if "user_db" not in st.session_state:
    # Pre-generate secure hashes for default users
...
# Render Auth Portal if User is NOT Logged In
if not st.session_state.get("authentication_status"):
    st.title("📍 GRIDPOINT Access Portal")
    st.markdown("##### Sign in or create an account to access the AI Warehouse Optimizer.")
...
if st.session_state.get("authentication_status"):
    ...
    # Active Session Authenticator Context
    authenticator = stauth.Authenticate(
        st.session_state["user_db"],
        cookie_name="gridpoint_auth_cookie",
        key="gridpoint_signature_key",
