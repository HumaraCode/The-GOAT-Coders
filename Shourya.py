...
# In a production environment, store these passwords securely in st.secrets or an environment variable.
# Passwords generated below use standard bcrypt hashing.
credentials = {
    "usernames": {
        "admin": {
            "name": "Admin User",
            "password": "$2b$12$eImiTXuWVxfM37uY4JANjOL.sB4V3A4I7jO46gYqC14V3l0qR5u4O"  # Pre-hashed password for "admin123"
        },
        "manager": {
...
if st.session_state.get("authentication_status") is False:
    ...
    # --- MAIN APPLICATION (PROTECTED CONTENT) ---
